...
export default function PrivacyPage() {
  const sections = [
    ...
    ["Technical information", "The service may process basic request and device information needed for security, rate limiting, hosting, and troubleshooting."],
    ["Website analytics", "Medoxy currently uses Vercel Web Analytics to measure page visits and website usage. Vercel processes limited request, device, and usage information on Medoxy's behalf to provide those measurements. If Google Analytics is enabled through the website configuration, Google may also process website usage information under its own privacy terms."],
